{
  description = "universal-project-manager - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 universal-project-manager development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "universal-project-manager";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P universal-project-manager.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/universal-project-manager $out/bin/  # Rust
            # cp bin/universal-project-manager $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/universal-project-manager";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-universal-project-manager" {
