...
// Replace universal-project-manager, Universal Project Manager — See README.adoc for details., just run, Universal Project Manager started successfully. with actuals
= universal-project-manager — Quick Start for Users
:toc:
:toclevels: 2

== What is universal-project-manager?

Universal Project Manager — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./universal-project-manager-portable
----
...
[source]
----
Universal Project Manager started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/universal-project-manager/wiki
