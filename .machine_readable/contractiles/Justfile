...
doctor:
    @echo "Running diagnostics for universal-project-manager..."
...
heal:
    @echo "Attempting auto-repair for universal-project-manager..."
...
tour:
    @echo "=== universal-project-manager Tour ==="
    @echo ""
...
help-me:
    @echo "=== universal-project-manager Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/universal-project-manager/issues/new"
    @echo ""
